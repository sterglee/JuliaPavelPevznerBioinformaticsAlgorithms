        ...
        for i in 1:k
            ...
            function profile_with_pseudocounts(motifs::Vector{String})
                ...
                for i in 1:k
                    ...
                    # Greedy Motif Search with Pseudocounts
                    # -----------------------------
                    function greedy_motif_search_pseudo(dna_list::Vector{String}, k::Int, t::Int)
                        ...
                        # Main Program
                        # -----------------------------
                        lines = readlines("data/stepic_3e.txt")
                        k, t = parse.(Int, split(String(lines[1])))
                        dna_list = [String(strip(line)) for line in lines[2:end]]

                            best_motifs = greedy_motif_search_pseudo(dna_list, k, t)
